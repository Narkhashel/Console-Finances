...
// Loop for calculating total Cash 
...
let sumAverageChange = 0;
let maxLoss = 0;
let maxProfit = 0;


//Loop to calculate avarage changes in Plrofi/Loss 
for (i = 0; i < (totalMonths - 1); i++ ) {

 sumAverageChange = (finances[i+1][1] - finances[i][1]) + sumAverageChange;

 averageChange = sumAverageChange / (totalMonths - 1);

 //inculded loop to calculate max profit/loss
